...
test_chrome_plugin_staging() {
    ...
    assert_contains "$chrome_dir/scripts/browser-client.mjs" "codexLinuxNativePipeFallback"
    assert_contains "$chrome_dir/scripts/browser-client.mjs" 'await import("node:net")'
